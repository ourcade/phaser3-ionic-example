          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _this2.hasMultipleCameras = devices.filter(d => d.kind == 'videoinput').length > 1;
                _context2.next = 10;
                break;
        ...
        regeneratorRuntime.mark(function _callee3() {
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                if (!constraints) {
                  constraints = _this3.defaultConstraints;
                }
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (!_this4.hasImageCapture()) {
                  _context4.next = 7;
                  break;
                }

                _this4.imageCapture = new window.ImageCapture(stream.getVideoTracks()[0]); // console.log(stream.getTracks()[0].getCapabilities());

                _context4.next = 7;
                return _this4.initPhotoCapabilities(_this4.imageCapture);

              case 7:
                // Always re-render
                _this4.el.forceUpdate();
            ...
            while (1) switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                if (c.fillLightMode.length > 1) {
                  _this5.flashModes = c.fillLightMode.map(m => m); // Try to recall the current flash mode

                  if (_this5.flashMode) {
                    _this5.flashMode = _this5.flashModes[_this5.flashModes.indexOf(_this5.flashMode)] || 'off';
                    _this5.flashIndex = _this5.flashModes.indexOf(_this5.flashMode) || 0;
                  } else {
                    _this5.flashIndex = 0;
                  }
                }
          ...
          return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.prev = 1;
                _context6.next = 4;
                return _this6.imageCapture.takePhoto({
                  fillLightMode: _this6.flashModes.length > 1 ? _this6.flashMode : undefined
                });

              case 4:
                photo = _context6.sent;
                _context6.next = 7;
                return _this6.flashScreen();

              case 7:
                _this6.promptAccept(photo);
        ...
        regeneratorRuntime.mark(function _callee7() {
          return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
              case 0:
                _this7.photo = photo;
                _this7.photoSrc = URL.createObjectURL(photo);
        ...
        regeneratorRuntime.mark(function _callee8() {
          return regeneratorRuntime.wrap(function _callee8$(_context8) {
            while (1) switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt("return", new Promise((resolve, _reject) => {
                  _this8.showShutterOverlay = true;
                  setTimeout(() => {
                    _this8.showShutterOverlay = false;
                    resolve();
                  }, 100);
                }));
